...
| --------- | --------------- | ------------ | --------- |
| RACK11 | Vlan4094 | 10.255.6.60 | Port-Channel1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet23 | - | 10.255.0.187/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet23 | - | 10.255.0.189/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet23 | - | 10.255.0.191/31 | default | 1550 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.255.4.32/32 |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.0.186 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.0.188 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.0.190 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65131
   ...
   neighbor 10.255.0.186 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.0.186 remote-as 65001
   neighbor 10.255.0.186 description spine1_Ethernet23
   neighbor 10.255.0.188 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.0.188 remote-as 65001
   neighbor 10.255.0.188 description spine2_Ethernet23
   neighbor 10.255.0.190 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.0.190 remote-as 65001
   neighbor 10.255.0.190 description spine3_Ethernet23
