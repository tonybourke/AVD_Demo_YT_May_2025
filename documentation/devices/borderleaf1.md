...
| --------- | --------------- | ------------ | --------- |
| BORDERLEAFS | Vlan4094 | 10.255.6.121 | Port-Channel1 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_spine1_Ethernet52 | - | 10.255.1.105/31 | default | 1550 | False | - | - |
| Ethernet4 | P2P_spine2_Ethernet52 | - | 10.255.1.107/31 | default | 1550 | False | - | - |
| Ethernet5 | P2P_spine3_Ethernet52 | - | 10.255.1.109/31 | default | 1550 | False | - | - |
| Ethernet6 | - | - | 10.1.5.0/31 | DMZ | - | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.255.4.61/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 10.255.5.61/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 10.255.4.61/32
!
interface Loopback1
   description VXLAN_TUNNEL_SOURCE
   no shutdown
   ip address 10.255.5.61/32
```
...
| Vlan3009 |  DMZ  |  10.255.7.120/31  |  -  |  -  |  -  |  -  |
| Vlan3010 |  Internal_A  |  10.255.7.120/31  |  -  |  -  |  -  |  -  |
| Vlan3011 |  Internal_B  |  10.255.7.120/31  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  10.255.7.120/31  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  10.255.6.120/31  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.255.1.104 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.1.106 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.1.108 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| 10.255.7.121 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.7.121 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | DMZ | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.1.5.1 | 1 | DMZ | - | - | - | - | - | - | - | - | - |
| 10.255.7.121 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Internal_A | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
| 10.255.7.121 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Internal_B | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.4.61:10010 | 10010:10010 | - | - | learned |
| 20 | 10.255.4.61:10020 | 10020:10020 | - | - | learned |
| 30 | 10.255.4.61:10030 | 10030:10030 | - | - | learned |
| 100 | 10.255.4.61:10100 | 10100:10100 | - | - | learned |
| 101 | 10.255.4.61:10101 | 10101:10101 | - | - | learned |
| 102 | 10.255.4.61:10102 | 10102:10102 | - | - | learned |
| 103 | 10.255.4.61:10103 | 10103:10103 | - | - | learned |
| 104 | 10.255.4.61:10104 | 10104:10104 | - | - | learned |
| 105 | 10.255.4.61:10105 | 10105:10105 | - | - | learned |
| 106 | 10.255.4.61:10106 | 10106:10106 | - | - | learned |
| 200 | 10.255.4.61:10200 | 10200:10200 | - | - | learned |
| 201 | 10.255.4.61:10201 | 10201:10201 | - | - | learned |
| 202 | 10.255.4.61:10202 | 10202:10202 | - | - | learned |
| 203 | 10.255.4.61:10203 | 10203:10203 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | Graceful Restart |
| --- | ------------------- | ------------ | ---------------- |
| DMZ | 10.255.4.61:10 | connected | - |
| Internal_A | 10.255.4.61:11 | connected | - |
| Internal_B | 10.255.4.61:12 | connected | - |
...
router bgp 65161
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER remote-as 65161
   neighbor MLAG-IPv4-UNDERLAY-PEER next-hop-self
   neighbor MLAG-IPv4-UNDERLAY-PEER description borderleaf2
   neighbor MLAG-IPv4-UNDERLAY-PEER route-map RM-MLAG-PEER-IN in
   neighbor MLAG-IPv4-UNDERLAY-PEER send-community
   neighbor MLAG-IPv4-UNDERLAY-PEER maximum-routes 12000
   neighbor 10.255.1.104 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.1.104 remote-as 65001
   neighbor 10.255.1.104 description spine1_Ethernet52
   neighbor 10.255.1.106 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.1.106 remote-as 65001
   neighbor 10.255.1.106 description spine2_Ethernet52
   neighbor 10.255.1.108 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.1.108 remote-as 65001
   neighbor 10.255.1.108 description spine3_Ethernet52
   ...
   neighbor 10.255.7.121 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 10.255.7.121 description borderleaf2_Vlan4093
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 10
      rd 10.255.4.61:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 20
      rd 10.255.4.61:10020
      route-target both 10020:10020
      redistribute learned
   !
   vlan 30
      rd 10.255.4.61:10030
      route-target both 10030:10030
      redistribute learned
   !
   vlan 100
      rd 10.255.4.61:10100
      route-target both 10100:10100
      redistribute learned
   !
   vlan 101
      rd 10.255.4.61:10101
      route-target both 10101:10101
      redistribute learned
   !
   vlan 102
      rd 10.255.4.61:10102
      route-target both 10102:10102
      redistribute learned
   !
   vlan 103
      rd 10.255.4.61:10103
      route-target both 10103:10103
      redistribute learned
   !
   vlan 104
      rd 10.255.4.61:10104
      route-target both 10104:10104
      redistribute learned
   !
   vlan 105
      rd 10.255.4.61:10105
      route-target both 10105:10105
      redistribute learned
   !
   vlan 106
      rd 10.255.4.61:10106
      route-target both 10106:10106
      redistribute learned
   !
   vlan 200
      rd 10.255.4.61:10200
      route-target both 10200:10200
      redistribute learned
   !
   vlan 201
      rd 10.255.4.61:10201
      route-target both 10201:10201
      redistribute learned
   !
   vlan 202
      rd 10.255.4.61:10202
      route-target both 10202:10202
      redistribute learned
   !
   vlan 203
      rd 10.255.4.61:10203
   ...
   vrf DMZ
      ...
      neighbor 10.255.7.121 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.7.121 description borderleaf2_Vlan3009
   ...
   vrf Internal_A
      ...
      router-id 10.255.4.61
      neighbor 10.255.7.121 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.7.121 description borderleaf2_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf Internal_B
      rd 10.255.4.61:12
      ...
      router-id 10.255.4.61
      neighbor 10.255.7.121 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.7.121 description borderleaf2_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
